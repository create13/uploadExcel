<template>
    <div>
        ...
        <div class="des-title">ldd页面数据处理</div>
        <div class="upload-file">
            <input @change="uploadLddFile" multiple="multiple" ref="file" type="file" class="input-opacity" />
            上传表格
        </div>
        <div @click="downLoadLddFile" class="download-file">下载文件</div>
  ...
  methods: {
        uploadLddFile () {
            ...
            reader.onload = async (e) => {
                ...
                axios.post('/api/uploadLddFile', {readBinary}).then(res => {
